...
## Run & verify (fast)
- **Dev (use this):** `preview_start name:karma` — the `karma` config already exists in `.Codex/launch.json` and runs `server_render.py` on port 3000. Then open `http://localhost:3000`.
